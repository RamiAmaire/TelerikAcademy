...
$.fn.flip = function(settings){
    return this.each( function() {
		...
		var revertedSettings = {
			...
			bgColor: acceptHexColor("#81B1E8"),
			color: $this.css("color", settings.color),
			content: $this.html(settings.content),
			oldClassName: $this.removeClass(settings.oldClass),
			newClassName: $this.addClass(settings.newClass),
        ...
        var defaultStart=function() {
            return {
                ...
                borderRightWidth:0,
                borderBottomWidth:0,
                borderTopColor: flipObj.bgColor,
                borderBottomColor: flipObj.bgColor,
                borderLeftColor: flipObj.bgColor,
                borderRightColor: flipObj.bgColor,
                background: flipObj.bgColor,
                borderStyle:'solid',
                height:0,
                width:0
            };
        ...
        ie6 && (dirOption.start.filter="chroma(color= #81B1E8)");
