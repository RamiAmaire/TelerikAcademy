...
/// <summary>
/// This class saves the events in ordered collections.
/// It also implements basic functionality with adding,
/// removing and listing the events in the collections.
/// </summary>
public class EventHolder
{
    ...
    public void RemoveEvents(string titleToDelete)
    {
