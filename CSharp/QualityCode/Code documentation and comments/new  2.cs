namespace Telerik.ILS.Common
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// 	Valid string cheking
        /// </summary>
        /// <param name="input">checked string</param>
        /// <returns>
		///		Returns bool if the input has true value (ex: true, ok, yes, 1, הא)
		/// </returns>
        public static bool ToBoolean(this string input)
        {
            string[] stringTrueValues = new[] { "true", "ok", "yes", "1", "הא" };
		...
		///		String that represents file extension
		///</param>
        /// <returns>
        ...
        /// <summary>
        /// 	Get decimal represented as ASCII
        /// </summary>
