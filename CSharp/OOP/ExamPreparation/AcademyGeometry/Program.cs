...
namespace GeometryAPI
{
    ...
    public class Circle : Figure, IAreaMeasurable, IFlat
    {
        ...
        public override string ToString()
        {
            return String.Format("{0}({1:0.00},{2:0.00},{3:0.00}){4:0.00}", this.GetType().Name, this.Center[0], this.Center[1], this.Center[2], this.Radius);
        }
    }
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        public override string ToString()
        {
            return String.Format("{0}({1:0.00},{2:0.00},{3:0.00})({4:0.00},{5:0.00},{6:0.00}){7:0.00}",
                this.GetType().Name, this.Top[0], this.Top[1], this.Top[2], this.Bottom[0], this.Bottom[1],
                this.Bottom[2], this.Radius);
        }
    }
    ...
    public class UpgradedFigureController : FigureController
    {
        // Methods
                ...
                case "area":
                    {
                        ...
                        {
                            var areableFigure = this.currentFigure as IAreaMeasurable;
                            Console.WriteLine("{0:0.00}", areableFigure.GetArea());
                        }
                        else
                        {
                ...
                case "volume":
                    {
                        ...
                        {
                            var areableFigure = this.currentFigure as IVolumeMeasurable;
                            Console.WriteLine("{0:0.00}", areableFigure.GetVolume());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
                ...
                case "normal":
                    {
                        ...
                        {
                            var areableFigure = this.currentFigure as IFlat;
                            Console.WriteLine(areableFigure.GetNormal().ToString());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
...
namespace AcademyGeometry
{
    class Program
    {
        ...
        {
            return new UpgradedFigureController(); // important
        }
