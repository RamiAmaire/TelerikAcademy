...
{
	public partial class ProductsDBModel : OpenAccessContext, IProductsDBModelUnitOfWork
	{
		private static string connectionStringName = @"Products_dbConnection";
		...
		public ProductsDBModel(string connection)
			:base(connection, backend, metadataSource)
		{ }
		
		public ProductsDBModel(BackendConfiguration backendConfiguration)
			:base(connectionStringName, backendConfiguration, metadataSource)
		{ }
			
		public ProductsDBModel(string connection, MetadataSource metadataSource)
			:base(connection, backend, metadataSource)
		{ }
	...
	public interface IProductsDBModelUnitOfWork : IUnitOfWork
	{
